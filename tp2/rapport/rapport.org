...
passe dans chaque machines mais dans des ordres et pendant des durées
différentes. Notre but est de minimiser le temps nécessaires pour que toutes les
pièces ai finit leur processus.
...
aléatoire on obtient les bons résultats la plupart du temps. Cependant pour
le cas du =la16= et =la20= le temps d'exécution est extrêmement long. Il nous
faudrait faire des optimisation plus complexes pour avoir des temps de calculs
plus raisonnables sur ces deux solutions.
...
compliqué. Cependant, on constate tout de même que nos algorithmes sont
relativement efficaces et trouve de bonnes solutions pour des problèmes simple
